import { b as MissingResourceServerError, c as Errors, m as MissingAuthorizationServerError } from "./errors-DUTJt7So.mjs";
...
function edgeResourcePath(req) {
	...
	if (received === "" || received === "/") throw Errors[MissingResourceServerError]();
...
* ```
*/
const withOAuthProtectedResource = defineMiddleware({
...
//#endregion
export { fromSupabaseUrl as i, resourceMetadataResponse as n, unauthorizedResponse as r, withOAuthProtectedResource as t };
